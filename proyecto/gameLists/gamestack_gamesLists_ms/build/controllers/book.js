...
var createBook = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, author, title, query;
    return __generator(this, function (_b) {
        logging_1.default.info(NAMESPACE, 'Inserting books');
        _a = req.body, author = _a.author, title = _a.title;
        query = "INSERT INTO books (author, title) VALUES (\"".concat(author, "\", \"").concat(title, "\")");
        (0, mysql_1.Connect)()
            .then(function (connection) {
            (0, mysql_1.Query)(connection, query)
                .then(function (result) {
                logging_1.default.info(NAMESPACE, 'Book created: ', result);
    ...
    return __generator(this, function (_a) {
        ...
        (0, mysql_1.Connect)()
            ...
            (0, mysql_1.Query)(connection, query)
                ...
                logging_1.default.info(NAMESPACE, 'Retrieved books: ', results);
                return res.status(200).json({
                    results: results
                });
            })
